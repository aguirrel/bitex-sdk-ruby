...
describe Bitex::Compliance::NaturalDocketSeed do
  ...
  describe '.create' do
    ...
    context 'with unauthorized key', vcr: { cassette_name: 'Compliance/natural_docket_seeds/create/unauthorized' } do
      it_behaves_like 'Not enough permissions'
    end

    context 'with unauthorized level key', vcr: { cassette_name: 'Compliance/natural_docket_seeds/create/unauthorized_key' } do
